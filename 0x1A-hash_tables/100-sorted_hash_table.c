...
/**
 * add_i_shash - adds a node on the doubly linked list of the sorted hash table
...
/**
 * shash_table_print_rev - prints the keys and values of the shash table in reverse
 * @ht: pointer to the shash table
 *
 * Return: no return
 */
